...
{
    /// <inheritdoc />
    public partial class nuevasRelacionesBD : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExamenMuestra_ExamenesSolicitados_ExamenSolicitadoId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ExamenMuestra_PersonalLaboratorio_PersonalLaboratorioId",
                        column: x => x.PersonalLaboratorioId,
                        principalTable: "PersonalLaboratorio",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExamenMuestraId = table.Column<long>(type: "bigint", nullable: false),
                    FechaCreacion = table.Column<DateTime>(type: "datetime2", nullable: false),
                    FechaModificacion = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Eliminado = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Resultados_ExamenMuestra_ExamenMuestraId",
                        column: x => x.ExamenMuestraId,
                        principalTable: "ExamenMuestra",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExamenMuestra_ExamenSolicitadoId",
                table: "ExamenMuestra",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExamenMuestra_PersonalLaboratorioId",
                table: "ExamenMuestra",
                column: "PersonalLaboratorioId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Resultados_ExamenMuestraId",
                table: "Resultados",
                column: "ExamenMuestraId");
